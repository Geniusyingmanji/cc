...
- Default provider is `claudecode`; use Claude Code with `claude-fable-5` unless the user explicitly asks for `/codex`.
- Treat `/mdr5/guest/users/zhangshuo/zyf` as the primary working directory.
